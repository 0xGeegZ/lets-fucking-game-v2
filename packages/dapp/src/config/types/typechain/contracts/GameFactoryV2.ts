...
export interface GameFactoryV2Interface extends utils.Interface {
  functions: {
    ...
    "pauseAllChildsAndFactory()": FunctionFragment;
    "paused()": FunctionFragment;
    "renounceOwnership()": FunctionFragment;
    "resumeAllChildsAndFactory()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "owner"
      | "pause"
      | "pauseAllChildsAndFactory"
      | "paused"
      | "renounceOwnership"
      | "resumeAllChildsAndFactory"
      | "setNewChild"
  ...
  encodeFunctionData(
    functionFragment: "pauseAllChildsAndFactory",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "resumeAllChildsAndFactory",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface GameFactoryV2 extends BaseContract {
  ...
  callStatic: {
    ...
    pauseAllChildsAndFactory(overrides?: CallOverrides): Promise<void>;

    paused(overrides?: CallOverrides): Promise<boolean>;

    renounceOwnership(overrides?: CallOverrides): Promise<void>;

    resumeAllChildsAndFactory(overrides?: CallOverrides): Promise<void>;
